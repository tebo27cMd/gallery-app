  ...
  if (photo) {
    ...
    return (
      <SafeAreaView style={styles.containerTwo}>
        ...
        <Button  style={styles.discardButton}  title="Pick an image from camera roll" onPress={pickImage} />
        {image && <Image source={{ uri: image }} style={{ width: '100%', height:  '80% ' , justifyContent: 'flex-end' }} />}
      </SafeAreaView>
    );
  }
